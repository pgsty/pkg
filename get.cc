...
# To install the latest version of pigsty (v3.0.0):
# curl -fsSL https://repo.pigsty.cc/get | bash

# To install a specific version of pigsty (e.g. v3.0.0)
# curl -fsSL https://repo.pigsty.cc/get | bash -s v3.0.0
