...
# License   :   AGPLv3
#==============================================================#
DEFAULT_VERSION=v3.0.0-b3
DEFAULT_REGION=global

# To install the latest version of pigsty (v3.0.0-b3):
# curl -fsSL https://repo.pigsty.cc/get | bash

# To install a specific version of pigsty (e.g. v2.7.0)
# curl -fsSL https://repo.pigsty.cc/get | bash -s v2.7.0
...
v2.5.1 v2.6.0 v2.7.0 v3.0.0-b3 v3.0.0"
