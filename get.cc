...
# To install a specific version of pigsty (e.g. v3.2.1)
# curl -fsSL https://repo.pigsty.cc/get | bash -s v3.2.1
...
#--------------------------------------------------------------#
log_line "${VERSION}"
log_hint "$ curl -fsSL https://repo.pigsty.cc/get | bash"
log_title "Site" "https://pigsty.cc"
...
DOWNLOAD_URL="https://repo.pigsty.cc/src/${SRC_FILENAME}"
